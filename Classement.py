...
@author: thieu
"""
#Le fichier classement correspond au classement des villes en focntions du nombre de vélos.

import json
import urllib
import urllib.request

apiKey = "apiKey=e0a1bf2c844edb9084efc764c089dd748676cc14"
#Récupération de la liste des villes
res = urllib.request.urlopen("https://api.jcdecaux.com/vls/v3/contracts?{}".format(apiKey)).read()
...
for i in range(len(js)-1):
    ...
    res_stat = urllib.request.urlopen("https://api.jcdecaux.com/vls/v3/stations?contract={}&{}".format(js[i]["name"],apiKey)).read()
    ...
    for j in range(len(js_stat)-1):
        res_fin = urllib.request.urlopen("https://api.jcdecaux.com/vls/v3/stations/{}?contract={}&{}".format(js_stat[j]["number"],name,apiKey)).read()
